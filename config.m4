...
if test "$PHP_RUNKIT" != "no"; then
  ...
  PHP_NEW_EXTENSION(runkit, runkit.c runkit_filter.c runkit_functions.c runkit_methods.c runkit_constants.c runkit_import.c runkit_classes.c runkit_sandbox.c, $ext_shared)
fi
