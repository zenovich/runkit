...
PHP_MINIT_FUNCTION(runkit)
{
	...
	REGISTER_LONG_CONSTANT("RUNKIT_FILTER_NULL",			PHP_RUNKIT_FILTER_NULL,				CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("RUNKIT_FILTER_BOOL",			PHP_RUNKIT_FILTER_BOOL,				CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("RUNKIT_FILTER_INT",				PHP_RUNKIT_FILTER_INT,				CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("RUNKIT_FILTER_FLOAT",			PHP_RUNKIT_FILTER_FLOAT,			CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("RUNKIT_FILTER_STRING",			PHP_RUNKIT_FILTER_STRING,			CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("RUNKIT_FILTER_ARRAY",			PHP_RUNKIT_FILTER_ARRAY,			CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("RUNKIT_FILTER_OBJECT",			PHP_RUNKIT_FILTER_OBJECT,			CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("RUNKIT_FILTER_RESOURCE",		PHP_RUNKIT_FILTER_RESOURCE,			CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("RUNKIT_FILTER_INSTANCE",		PHP_RUNKIT_FILTER_INSTANCE,			CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("RUNKIT_FILTER_NONEMPTY",		PHP_RUNKIT_FILTER_NONEMPTY,			CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("RUNKIT_FILTER_ALPHA",			PHP_RUNKIT_FILTER_ALPHA,			CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("RUNKIT_FILTER_DIGIT",			PHP_RUNKIT_FILTER_DIGIT,			CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("RUNKIT_FILTER_ALNUM",			PHP_RUNKIT_FILTER_ALNUM,			CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("RUNKIT_FILTER_GPC_ON",			PHP_RUNKIT_FILTER_GPC_ON,			CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("RUNKIT_FILTER_GPC_OFF",			PHP_RUNKIT_FILTER_GPC_OFF,			CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("RUNKIT_FILTER_IPV4",			PHP_RUNKIT_FILTER_IPV4,				CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("RUNKIT_FILTER_IPV6",			PHP_RUNKIT_FILTER_IPV6,				CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("RUNKIT_FILTER_IP",				PHP_RUNKIT_FILTER_IP,				CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("RUNKIT_FILTER_HOSTNAME",		PHP_RUNKIT_FILTER_HOSTNAME,			CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("RUNKIT_FILTER_SCHEME_FILE",		PHP_RUNKIT_FILTER_SCHEME_FILE,		CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("RUNKIT_FILTER_SCHEME_ANY",		PHP_RUNKIT_FILTER_SCHEME_ANY,		CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("RUNKIT_FILTER_SCHEME_NETWORK",	PHP_RUNKIT_FILTER_SCHEME_NETWORK,	CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("RUNKIT_FILTER_SCHEME_LOCAL",	PHP_RUNKIT_FILTER_SCHEME_LOCAL,		CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("RUNKIT_FILTER_SCHEME",			PHP_RUNKIT_FILTER_SCHEME,			CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("RUNKIT_FILTER_USER",			PHP_RUNKIT_FILTER_USER,				CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("RUNKIT_FILTER_INLINE",			PHP_RUNKIT_FILTER_INLINE,			CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("RUNKIT_FILTER_EREG",			PHP_RUNKIT_FILTER_EREG,				CONST_CS | CONST_PERSISTENT);
